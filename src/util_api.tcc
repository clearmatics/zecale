...
void prepare_proof_response(
    extended_proof<ppT> &ext_proof, aggregator_proto::ExtendedProof *message)
{
...
void prepare_verification_key_response(
    ...
    aggregator_proto::VerificationKey *message)
{
    aggregator_proto::HexPointBaseGroup1Affine *a =
        new aggregator_proto::HexPointBaseGroup1Affine(); // in G1
    aggregator_proto::HexPointBaseGroup2Affine *b =
        new aggregator_proto::HexPointBaseGroup2Affine(); // in G2
    aggregator_proto::HexPointBaseGroup2Affine *d =
        new aggregator_proto::HexPointBaseGroup2Affine(); // in G2
    ...
    // See:
    // https://stackoverflow.com/questions/33960999/protobuf-will-set-allocated-delete-the-allocated-object
    aggregator_proto::VerificationKeyGROTH16 *grpc_verification_key_groth16 =
