...
public:
    ...
    std::vector<std::shared_ptr<libsnark::G1_checker_gadget<ppT> > > all_G1_checkers;
    std::shared_ptr<libsnark::G2_checker_gadget<ppT> > G2_checker;

    libsnark::pb_variable_array<FieldT> proof_contents;

    r1cs_gg_ppzksnark_proof_variable(libsnark::protoboard<FieldT> &pb,
...
public:
    ...
    __attribute__((noinline)) r1cs_gg_ppzksnark_verification_key_variable(libsnark::protoboard<FieldT> &pb,
...
public:
    ...
    r1cs_gg_ppzksnark_preprocessed_r1cs_gg_ppzksnark_verification_key_variable(libsnark::protoboard<FieldT> &pb,
...
public:
    ...
    std::shared_ptr<libsnark::precompute_G1_gadget<ppT> > compute_vk_alpha_g1_precomp;

    std::shared_ptr<libsnark::precompute_G2_gadget<ppT> > compute_vk_generator_g2_precomp;
    std::shared_ptr<libsnark::precompute_G2_gadget<ppT> > compute_vk_beta_g2_precomp;
    std::shared_ptr<libsnark::precompute_G2_gadget<ppT> > compute_vk_delta_g2_precomp;
    ...
    r1cs_gg_ppzksnark_verifier_process_vk_gadget(libsnark::protoboard<FieldT> &pb,
...
public:
    ...
    std::shared_ptr<libsnark::precompute_G1_gadget<ppT> > compute_proof_g_A_precomp;
    std::shared_ptr<libsnark::precompute_G1_gadget<ppT> > compute_proof_g_B_precomp;
    std::shared_ptr<libsnark::precompute_G1_gadget<ppT> > compute_proof_g_C_precomp;
    ...
    r1cs_gg_ppzksnark_online_verifier_gadget(libsnark::protoboard<FieldT> &pb,
...
public:
    ...
    r1cs_gg_ppzksnark_verifier_gadget(libsnark::protoboard<FieldT> &pb,
                                   const r1cs_gg_ppzksnark_verification_key_variable<ppT> &vk,
                                   const libsnark::pb_variable_array<FieldT> &input,
                                   const size_t elt_size,
                                   const r1cs_gg_ppzksnark_proof_variable<ppT> &proof,
